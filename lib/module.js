...
module.exports = function sparingCenter (moduleOptions) {
  ...
  */
  if (options.styleResources !== false) {
    ...
    if (options.sassUtilsCollection !== false) {
      this.options.styleResources.scss.unshift('~/node_modules/@sparing-software/nuxt-sparing-center/lib/sass-utils-collection.scss')
    }
